...
public class MailController {
    ...
    public ResponseEntity<MailServiceResponse> sendMail(
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new MailServiceResponse(
                            MailServiceHttpResponseCodes.SEND_MAIL_SUCCESSFUL,
                            MailServiceMessage.SEND_MAIL_SUCCESSFUL,
                            null));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(
                            new MailServiceResponse(
                                    MailServiceHttpResponseCodes.SEND_MAIL_FAILED,
                                    MailServiceMessage.SEND_MAIL_FAILED,
                                    null));
        }
    }
}

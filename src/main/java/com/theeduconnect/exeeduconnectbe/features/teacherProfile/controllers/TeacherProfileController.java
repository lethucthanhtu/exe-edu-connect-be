...
public class TeacherProfileController {
    ...
    @Autowired
    public TeacherProfileController(TeacherProfileService teacherProfileService, JwtService jwtService) {
    ...
    public ResponseEntity<TeacherProfileServiceResponse> GetTeachersByCourseCategory(
        ...
        try {
            ...
            UpdateTeacherProfileDto dto = BuildUpdateTeacherProfileDto(request, userId, cardphoto, nationalid, cv, certificates);
            TeacherProfileServiceResponse response = teacherProfileService.update(dto);
            return new ResponseEntity<>(response, HttpStatusCode.valueOf(response.getStatusCode()));
        } catch (Exception e) {
            return new ResponseEntity<>(new TeacherProfileServiceResponse(500,e.getMessage(),null),
    ...
    private UpdateTeacherProfileDto BuildUpdateTeacherProfileDto(String request,
                                                                 int userId,

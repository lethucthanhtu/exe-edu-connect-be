...
public class UpdateTeacherProfileDto {
    ...
    @NotNull(message = TeacherProfileValidationMessages.DATE_OF_BIRTH_VALID) private LocalDate dateofbirth;
    ...
    //    @Pattern(regexp = TeacherProfileValidationSpecifications.VALID_EMAIL, message =
    // TeacherProfileValidationMessages.EMAIL_VALID)
    //    private String email;
    @NotBlank(message = TeacherProfileValidationMessages.PHONE_VALID)
    @Pattern(
            regexp = TeacherProfileValidationSpecifications.VALID_PHONE,
            message = TeacherProfileValidationMessages.PHONE_VALID)
    ...
    @JsonIgnore private MultipartFile[] certificates;
}

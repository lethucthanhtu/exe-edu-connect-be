...
public class AuthenticationServiceMessages {
    ...
    public static String INVALID_ROLE_RESULT = "The given role is non-existent in the system. Please try another one.";
    public static String INTERNAL_SERVER_ERROR = "Something went wrong on the server side.";
    public static String INVALID_LOGIN_CREDENTIALS = "Either the email is non-existent, or the password is incorrect. Please try again.";
}

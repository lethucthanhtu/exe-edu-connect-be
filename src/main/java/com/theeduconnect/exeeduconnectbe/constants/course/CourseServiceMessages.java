...
public class CourseServiceMessages {
    ...
    public static final String JOIN_COURSE_SUCCESSFUL = "Successfully added the student to the course schedule.";
    ...
    public static final String COURSE_SCHEDULE_TAKEN =
            "The selected course schedule is already taken by another student. Please choose a different course schedule.";
    public static final String  COURSE_SCHEDULE_NOT_FOUND =
    "The given course schedule is not found in the selected class. Plesae choose another course schedule.";
}
